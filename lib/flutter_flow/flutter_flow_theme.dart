...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF87AFC7);
  late Color alternate = const Color(0xFFF3F6FA);
  ...
  late Color accent1 = const Color(0xFF87AFC7);
  late Color accent2 = const Color(0xFFFFD700);
  late Color accent3 = const Color(0xFFE5E5E5);
  late Color accent4 = const Color(0xFF00457C);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFC1A32D);
  late Color tertiary = const Color(0xFF4E8BA8);
  late Color alternate = const Color(0xFF2B3E50);
  ...
  late Color accent1 = const Color(0xFF4E8BA8);
  late Color accent2 = const Color(0xFFD4AF37);
  late Color accent3 = const Color(0xFF3E3E3E);
  late Color accent4 = const Color(0xFF7289DA);
  late Color success = const Color(0xFF28A745);
  late Color warning = const Color(0xFFF39C12);
  late Color error = const Color(0xFFE74C3C);
  late Color info = const Color(0xFF3498DB);

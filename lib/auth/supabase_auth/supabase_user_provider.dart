...
class LawFirmArabicAppSupabaseUser extends BaseAuthUser {
  LawFirmArabicAppSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> lawFirmArabicAppSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = LawFirmArabicAppSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
